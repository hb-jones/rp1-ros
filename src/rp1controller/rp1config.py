...
class RP1Configuration(): 
    ...
    polypath_max_speed = 3 #How fast robot can be going to trigger polypath
    polypath_time = 1.5#polypath_max_speed/acceleration_max #How long should final path to position take
